...
public class PrincipalController extends BaseScreenController{
    ...
    public void sacarAlertInfo(String mensaje) {
        ...
        alert.setContentText(mensaje);
        alert.getDialogPane().setId("information");
        alert.getDialogPane().lookupButton(ButtonType.OK).setId(Constants.BTN_OK);
        alert.showAndWait();
    }
    ...
    public void onLoginDone(Credential credential) {
        ...
        if (!actualCredential.getUser_name().equals("root")) {
