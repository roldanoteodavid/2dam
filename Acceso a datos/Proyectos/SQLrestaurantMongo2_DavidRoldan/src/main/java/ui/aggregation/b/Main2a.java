...
public class Main2a {
    public static void main(String[] args) {
        ...
        Either<RestaurantError, String> either = aggregationService.ex2A();

        System.out.println(" a. Name and number of episodes of character who appear more than 10 times and less than 30.");
        if (either.isRight()) {
