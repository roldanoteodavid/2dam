...
public class SQLQueries {
    ...
    public static final String DELETE_FROM_ORDER_ITEMS_WHERE_ORDER_ID_SELECT_ORDER_ID_FROM_ORDERS_WHERE_CUSTOMER_ID = "DELETE FROM order_items WHERE order_id IN (SELECT order_id FROM orders WHERE customer_id = ?)";
    ...
    public static final String SELECT_FROM_ORDERS_WHERE_CUSTOMER_ORDERS = "SELECT o.order_id, o.order_date, o.customer_id, o.table_id, oi.order_item_id, oi.menu_item_id, oi.quantity, mi.name, mi.description, mi.price FROM orders o JOIN order_items oi ON o.order_id = oi.order_id JOIN menu_items mi ON oi.menu_item_id = mi.menu_item_id WHERE o.customer_id = ?;";
    ...
    public static final String SELECT_FROM_ORDER_ITEMS_WHERE_ORDERITEM_ID = "SELECT oi.order_item_id, oi.order_id, oi.menu_item_id, oi.quantity, mi.name, mi.description, mi.price FROM order_items oi INNER JOIN menu_items mi ON oi.menu_item_id = mi.menu_item_id WHERE oi.order_id=?";
