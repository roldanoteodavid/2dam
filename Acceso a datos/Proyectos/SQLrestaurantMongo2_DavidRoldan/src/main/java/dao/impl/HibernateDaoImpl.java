...
//            String query = "SELECT c FROM CustomerHib c LEFT JOIN FETCH c.orders o LEFT JOIN FETCH o.orderItems";
//            List<CustomerHib> customers = em.createQuery("from CustomerHib", CustomerHib.class).getResultList();
            List<CustomerHib> customers = em.createNamedQuery("CustomerHib.getAll", CustomerHib.class).getResultList();
