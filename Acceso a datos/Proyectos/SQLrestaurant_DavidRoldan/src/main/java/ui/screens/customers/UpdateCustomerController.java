...
public class UpdateCustomerController extends BaseScreenController {
    ...
    public void updateCustomer() {
        servicesCustomers.save(new Customer(Integer.parseInt(idField.getText()), fnameField.getText(), lnameField.getText(), emailField.getText(), phoneField.getText(), dobField.getValue())).peek(customerInt -> {
                    if (customerInt == 1) {
