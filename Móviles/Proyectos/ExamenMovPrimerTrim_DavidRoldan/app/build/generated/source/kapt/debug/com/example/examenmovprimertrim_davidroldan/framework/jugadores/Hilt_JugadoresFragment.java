package com.example.examenmovprimertrim_davidroldan.framework.jugadores;
 ...
 */
public abstract class Hilt_JugadoresFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_JugadoresFragment() {
    super();
  }

  Hilt_JugadoresFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JugadoresFragment_GeneratedInjector) this.generatedComponent()).injectJugadoresFragment(UnsafeCasts.<JugadoresFragment>unsafeCast(this));
    }
  }
