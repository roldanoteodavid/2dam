 ...
 */
public abstract class Hilt_EquiposFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EquiposFragment() {
    super();
  }

  Hilt_EquiposFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EquiposFragment_GeneratedInjector) this.generatedComponent()).injectEquiposFragment(UnsafeCasts.<EquiposFragment>unsafeCast(this));
    }
  }
