 ...
 */
public abstract class Hilt_DetalleEquipoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DetalleEquipoFragment() {
    super();
  }

  Hilt_DetalleEquipoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DetalleEquipoFragment_GeneratedInjector) this.generatedComponent()).injectDetalleEquipoFragment(UnsafeCasts.<DetalleEquipoFragment>unsafeCast(this));
    }
  }
