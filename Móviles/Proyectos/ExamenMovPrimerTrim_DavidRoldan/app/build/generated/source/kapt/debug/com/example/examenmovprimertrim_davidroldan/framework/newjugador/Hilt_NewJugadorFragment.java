 ...
 */
public abstract class Hilt_NewJugadorFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewJugadorFragment() {
    super();
  }

  Hilt_NewJugadorFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewJugadorFragment_GeneratedInjector) this.generatedComponent()).injectNewJugadorFragment(UnsafeCasts.<NewJugadorFragment>unsafeCast(this));
    }
  }
