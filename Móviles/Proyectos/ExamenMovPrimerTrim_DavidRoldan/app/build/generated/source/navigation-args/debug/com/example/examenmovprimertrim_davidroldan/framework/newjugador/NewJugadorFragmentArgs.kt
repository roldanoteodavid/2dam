...
public data class NewJugadorFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): NewJugadorFragmentArgs {
      bundle.setClassLoader(NewJugadorFragmentArgs::class.java.classLoader)
      val __id : String?
      ...
      return NewJugadorFragmentArgs(__id, __name)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): NewJugadorFragmentArgs {
      val __id : String?
