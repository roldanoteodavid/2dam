...
class ChangePasswordUseCase @Inject constructor(var repository: LoginRepository){
    suspend operator fun invoke(credentials: Credentials) = repository.changePassword(credentials)
}