 ...
 */
public abstract class Hilt_OrdersFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OrdersFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrdersFragment_GeneratedInjector) this.generatedComponent()).injectOrdersFragment(UnsafeCasts.<OrdersFragment>unsafeCast(this));
    }
  }
