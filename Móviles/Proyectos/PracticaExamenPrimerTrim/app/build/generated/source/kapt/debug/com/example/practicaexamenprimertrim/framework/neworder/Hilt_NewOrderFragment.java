 ...
 */
public abstract class Hilt_NewOrderFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewOrderFragment() {
    super();
  }

  Hilt_NewOrderFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewOrderFragment_GeneratedInjector) this.generatedComponent()).injectNewOrderFragment(UnsafeCasts.<NewOrderFragment>unsafeCast(this));
    }
  }
