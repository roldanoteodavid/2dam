...
public data class OrdersFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): OrdersFragmentArgs {
      bundle.setClassLoader(OrdersFragmentArgs::class.java.classLoader)
      ...
      return OrdersFragmentArgs(__idcustomer)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): OrdersFragmentArgs {
      val __idcustomer : Int?
